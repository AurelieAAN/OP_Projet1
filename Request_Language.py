...
def get_detection_language(tenant_id, client_id, client_secret, secret_name_cg, endpoint_kv, endpoint_cg, entry_user):
    """
    [summary]
    ...
    credential = AzureKeyCredential(secret.value)
    text_analytics_client = TextAnalyticsClient(endpoint_cg, credential)
